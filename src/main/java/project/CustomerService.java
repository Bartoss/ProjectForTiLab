...
public class CustomerService {
    ...
    /**
     * @return a reference to an example facade for project.Customer objects.
     */
    ...
    /**
     * @return all available project.Customer objects.
     */
    ...
    /**
     * Finds all project.Customer's that match given filter.
     *
     * @param stringFilter
     *            filter that returned objects should match or null/empty string
     *            if all objects should be returned.
     * @return list a project.Customer objects
     */
    ...
    /**
     * Finds all project.Customer's that match given filter and limits the resultset.
     *
     * @param stringFilter
     *            filter that returned objects should match or null/empty string
     *            if all objects should be returned.
     ...
     *
     * @param value
     *            the project.Customer to be deleted
     */
     ...
     * for new project.Customer instances.
     *
     * @param entry
     */
    public synchronized void save(Customer entry) {
        if (entry == null) {
            LOGGER.log(Level.SEVERE,
                    "project.Customer is null. Are you sure you have connected your form to the application as described in tutorial chapter 7?");
            return;
        }
        if (entry.getId() == null) {
            entry.setId(nextId++);
